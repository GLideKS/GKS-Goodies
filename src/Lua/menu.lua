...
local ExampleMenu = {
    {
        ...
        entries = {
            ...
            {text = "Nametags scale", cvar = CV_FindVar("nametags_scale"), y_pos = 42},
            {text = "Bubble Status", cvar = CV_FindVar("bubble_status"), y_pos = 52},

            {header = true, text = "Server Options", y_pos = 64},
            {text = "Allow Ring Sharing", cvar = CV_FindVar("ring_sharing"), y_pos = 76},
            {text = "Allow Nametags", cvar = CV_FindVar("allownametags"), y_pos = 86},
            {text = "Allow Windlines", cvar = CV_FindVar("globalwindlines"), y_pos = 96},
            {text = "Friendly Fire tweaks...", y_pos = 106},
            {text = "Race/Competition tweaks...", y_pos = 116},
